...
El script devuelve un estado de ejemplo (`Online`) para practicar la forma del resultado. No representa el estado real de Azure ni consulta recursos reales.
